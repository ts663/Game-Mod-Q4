...
public:
	...
	CLASS_PROTOTYPE(rvMonsterPokemonGladiator);

	rvMonsterPokemonGladiator(void);
...
/*
================
rvMonsterPokemonGladiator::rvMonsterPokemonGladiator
================
*/
rvMonsterPokemonGladiator::rvMonsterPokemonGladiator() {
	usingShield = false;
...
void rvMonsterPokemonGladiator::InitSpawnArgsVariables(void)
{
...
/*
================
rvMonsterPokemonGladiator::Spawn
================
*/
void rvMonsterPokemonGladiator::Spawn(void) {
	shieldWaitTime = 0;
	shieldStartTime = 0;
	shieldHealth = 250;
...
/*
================
rvMonsterPokemonGladiator::CheckActions
...
================
*/
bool rvMonsterPokemonGladiator::CheckActions(void) {
...
/*
================
rvMonsterPokemonGladiator::ShowShield
================
*/
void rvMonsterPokemonGladiator::ShowShield(void) {
	// First time?
	if (!shield) {
		idEntity* ent;
		idDict   args;
...
/*
================
rvMonsterPokemonGladiator::HideShield
================
*/
void rvMonsterPokemonGladiator::HideShield(int hideTime) {
...
/*
================
rvMonsterPokemonGladiator::DestroyRailgun
================
*/
void rvMonsterPokemonGladiator::DestroyRailgun(void) {
...
/*
================
rvMonsterPokemonGladiator::UpdateRunStatus
================
*/
bool rvMonsterPokemonGladiator::UpdateRunStatus(void) {
...
/*
============
rvMonsterPokemonGladiator::SetTether
============
*/
/*
void rvMonsterPokemonGladiator::SetTether ( rvAITether* newTether ) {
	if ( railgunHealth <= 0 ) {
...
/*
================
rvMonsterPokemonGladiator::FilterTactical
================
*/
int rvMonsterPokemonGladiator::FilterTactical(int availableTactical) {
...
/*
================
rvMonsterPokemonGladiator::AddDamageEffect
================
*/
void rvMonsterPokemonGladiator::AddDamageEffect(const trace_t& collision, const idVec3& velocity, const char* damageDefName, idEntity* inflictor) {
...
/*
=====================
rvMonsterPokemonGladiator::GetDamageForLocation
=====================
*/
int rvMonsterPokemonGladiator::GetDamageForLocation(int damage, int location) {
...
/*
================
rvMonsterPokemonGladiator::CanTurn
================
*/
bool rvMonsterPokemonGladiator::CanTurn(void) const {
	if (!idAI::CanTurn()) {
		return false;
	}
...
/*
================
rvMonsterPokemonGladiator::Damage
================
*/
void rvMonsterPokemonGladiator::Damage(idEntity* inflictor, idEntity* attacker, const idVec3& dir,
...
/*
================
rvMonsterPokemonGladiator::Save
================
*/
void rvMonsterPokemonGladiator::Save(idSaveGame* savefile) const {
...
/*
================
rvMonsterPokemonGladiator::Restore
================
*/
void rvMonsterPokemonGladiator::Restore(idRestoreGame* savefile) {
...
/*
================
rvMonsterPokemonGladiator::GetDebugInfo
================
*/
void rvMonsterPokemonGladiator::GetDebugInfo(debugInfoProc_t proc, void* userData) {
	// Base class first
...
CLASS_STATES_DECLARATION(rvMonsterPokemonGladiator)
STATE("State_Killed", rvMonsterPokemonGladiator::State_Killed)

STATE("Torso_BlasterAttack", rvMonsterPokemonGladiator::State_Torso_BlasterAttack)
STATE("Torso_RailgunAttack", rvMonsterPokemonGladiator::State_Torso_RailgunAttack)
STATE("Torso_ShieldStart", rvMonsterPokemonGladiator::State_Torso_ShieldStart)
STATE("Torso_ShieldEnd", rvMonsterPokemonGladiator::State_Torso_ShieldEnd)

STATE("Torso_TurnRight90", rvMonsterPokemonGladiator::State_Torso_TurnRight90)
STATE("Torso_TurnLeft90", rvMonsterPokemonGladiator::State_Torso_TurnLeft90)
STATE("Torso_ShieldFire", rvMonsterPokemonGladiator::State_Torso_ShieldFire)

END_CLASS_STATES

/*
================
rvMonsterPokemonGladiator::State_Killed
================
*/
stateResult_t rvMonsterPokemonGladiator::State_Killed(const stateParms_t& parms) {
	HideShield();
...
/*
================
rvMonsterPokemonGladiator::State_Torso_ShieldStart
================
*/
stateResult_t rvMonsterPokemonGladiator::State_Torso_ShieldStart(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT
	};
...
/*
================
rvMonsterPokemonGladiator::State_Torso_ShieldEnd
================
*/
stateResult_t rvMonsterPokemonGladiator::State_Torso_ShieldEnd(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT
	};
...
/*
================
rvMonsterPokemonGladiator::State_Torso_BlasterAttack
================
*/
stateResult_t rvMonsterPokemonGladiator::State_Torso_BlasterAttack(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAITSTART,
		STAGE_LOOP,
...
/*
================
rvMonsterPokemonGladiator::State_Torso_RailgunAttack
================
*/
stateResult_t rvMonsterPokemonGladiator::State_Torso_RailgunAttack(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT
	};
...
/*
================
rvMonsterPokemonGladiator::State_Torso_TurnRight90
================
*/
stateResult_t rvMonsterPokemonGladiator::State_Torso_TurnRight90(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT
	};
...
/*
================
rvMonsterPokemonGladiator::State_Torso_TurnLeft90
================
*/
stateResult_t rvMonsterPokemonGladiator::State_Torso_TurnLeft90(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT
	};
...
/*
================
rvMonsterPokemonGladiator::State_Torso_ShieldFire
================
*/
stateResult_t rvMonsterPokemonGladiator::State_Torso_ShieldFire(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_ATTACK,
		STAGE_ATTACK_WAIT,
