...
public:
	...
	CLASS_PROTOTYPE(rvMonsterPokemonBossMakron);

	rvMonsterPokemonBossMakron(void);
...
protected:
	...
	CLASS_STATES_PROTOTYPE(rvMonsterPokemonBossMakron);
};
...
CLASS_DECLARATION(idAI, rvMonsterPokemonBossMakron)
EVENT(EV_AllowMoreSpawns, rvMonsterPokemonBossMakron::Event_AllowMoreSpawns)
EVENT(EV_SetNextAction, rvMonsterPokemonBossMakron::Event_SetNextAction)
EVENT(EV_EnablePatternMode, rvMonsterPokemonBossMakron::Event_EnablePatternMode)
EVENT(EV_DisablePatternMode, rvMonsterPokemonBossMakron::Event_DisablePatternMode)
EVENT(EV_StompAttack, rvMonsterPokemonBossMakron::Event_StompAttack)
EVENT(EV_Separate, rvMonsterPokemonBossMakron::Event_Separate)
...
/*
================
rvMonsterPokemonBossMakron::rvMonsterPokemonBossMakron
================
*/
rvMonsterPokemonBossMakron::rvMonsterPokemonBossMakron(void) {
...
/*
================
rvMonsterPokemonBossMakron::BuildActionArray ( void )
================
*/
void rvMonsterPokemonBossMakron::BuildActionArray(void) {
...
/*
================
rvMonsterPokemonBossMakron::Save
================
*/
void rvMonsterPokemonBossMakron::Save(idSaveGame* savefile) const {
...
/*
================
rvMonsterPokemonBossMakron::Restore
================
*/
void rvMonsterPokemonBossMakron::Restore(idRestoreGame* savefile) {
...
/*
================
rvMonsterPokemonBossMakron::StopAllEffects
================
*/
void rvMonsterPokemonBossMakron::StopAllEffects(void) {
...
/*
================
rvMonsterPokemonBossMakron::StopAllBoltEffects
================
*/
void rvMonsterPokemonBossMakron::StopAllBoltEffects(void) {
...
void rvMonsterPokemonBossMakron::InitSpawnArgsVariables(void) {
	//slick!
...
/*
================
rvMonsterPokemonBossMakron::Spawn
================
*/
void rvMonsterPokemonBossMakron::Spawn(void) {
	...
	maxHealth *= pow;
	health = maxHealth;
	gameLocal.Printf("Spawned pokemon boss makron\n");
	PrintDets();
...
/*
================
rvMonsterPokemonBossMakron::PrintDets
================
*/
void rvMonsterPokemonBossMakron::PrintDets(void) {
	gameLocal.Printf("--------------------------------------\n");
	gameLocal.Printf("%s\n", name.c_str());
...
/*
================
rvMonsterPokemonBossMakron::GiveXP
================
*/
void rvMonsterPokemonBossMakron::GiveXP(int amount) {
	int orig = amount;
	while (amount > 0) {
...
/*
================
rvMonsterPokemonBossMakron::Attack1
================
*/
void rvMonsterPokemonBossMakron::Attack1(void) {
...
/*
================
rvMonsterPokemonBossMakron::Attack2
================
*/
void rvMonsterPokemonBossMakron::Attack2(void) {
	idAI* enemy = gameLocal.GetLocalPlayer()->activeEnemy;
	if (!enemy) {
		return;
	}
...
/*
================
rvMonsterPokemonBossMakron::Attack3
================
*/
void rvMonsterPokemonBossMakron::Attack3(void) {
	idAI* enemy = gameLocal.GetLocalPlayer()->activeEnemy;
	if (!enemy) {
		return;
	}
	...
	TurnToward(enemy->GetEyePosition());
	PlayAnim(ANIMCHANNEL_LEGS, "range_cannon_fire", 4);
	waitingforattack = true;
	double pow = 1.0;
	for (int i = 1; i < level; i++) {
		pow *= 1.5;
...
/*
================
rvMonsterPokemonBossMakron::Heal
================
*/
void rvMonsterPokemonBossMakron::Heal(void) {
	idAI* enemy = gameLocal.GetLocalPlayer()->activeEnemy;
	if (!enemy) {
		return;
	}
...
/*
================
rvMonsterPokemonBossMakron::Think
================
*/
void rvMonsterPokemonBossMakron::Think(void) {
	idAI::Think();
...
/*
================
rvMonsterPokemonBossMakron::CheckTurnActions
================
*/
bool rvMonsterPokemonBossMakron::CheckTurnActions(void) {
...
/*
================
rvMonsterPokemonBossMakron::CheckActions
================
*/
bool rvMonsterPokemonBossMakron::CheckActions(void) {
...
================
*/
void rvMonsterPokemonBossMakron::PerformPatternedAction() {
...
================
*/
bool rvMonsterPokemonBossMakron::CanTurn(void) const {
	if (!flagFlyingMode) {
		if (!idAI::CanTurn()) {
			return false;
		}
...
================
*/
void rvMonsterPokemonBossMakron::InitBoltSweep(idVec3 idealTarget) {
...
================
*/
void rvMonsterPokemonBossMakron::MaintainBoltSweep(void) {
	enum {
		STATE_START,
		STATE_WAIT1,
		STATE_SWEEP1,
...
/*
================
rvMonsterPokemonBossMakron::LightningSweep
================
*/
void rvMonsterPokemonBossMakron::LightningSweep(idVec3 attackVector, rvClientEffectPtr& boltEffect, rvClientEffectPtr& impactEffect) {
...
/*
================
rvMonsterPokemonBossMakron::PerformAction
================
*/
void rvMonsterPokemonBossMakron::PerformAction(const char* stateName, int blendFrames, bool noPain) {
...
================
*/
bool rvMonsterPokemonBossMakron::PerformAction(rvAIAction* action, bool (idAI::* condition)(rvAIAction*, int), rvAIActionTimer* timer) {
...
================
*/
void rvMonsterPokemonBossMakron::OnStopAction(void) {
	////gameLocal.Printf("\n\nAction stopped ----------- \n");
}

/*
================
rvMonsterPokemonBossMakron::Damage
================
*/
void rvMonsterPokemonBossMakron::Damage(idEntity* inflictor, idEntity* attacker, const idVec3& dir,
...
/*
================
rvMonsterPokemonBossMakron::Killed
================
*/
void rvMonsterPokemonBossMakron::Killed(idEntity* inflictor, idEntity* attacker, int damage, const idVec3& dir, int location) {
...
/*
================
rvMonsterPokemonBossMakron::BeginSeparation( void )
================
*/
void rvMonsterPokemonBossMakron::BeginSeparation(void) {
...
/*
================
rvMonsterPokemonBossMakron::CompleteSeparation( void )
================
*/
void rvMonsterPokemonBossMakron::CompleteSeparation(void) {
...
/*
================
rvMonsterPokemonBossMakron::ScriptedFace( idEntity* faceEnt, bool endWithIdle )
================
*/
/*
void rvMonsterPokemonBossMakron::ScriptedFace ( idEntity* faceEnt, bool endWithIdle ) {
...
/*
================
rvMonsterPokemonBossMakron::Event_AllowMoreSpawns
================
*/
// this will allow Makron to spawn more baddies.
void rvMonsterPokemonBossMakron::Event_AllowMoreSpawns(void) {
	flagAllowSpawns = true;
}

/*
================
rvMonsterPokemonBossMakron::Event_EnablePatternMode
================
*/
// When set, the Makron will now only fight via scripted patterns
void rvMonsterPokemonBossMakron::Event_EnablePatternMode(void) {
	patternedMode = true;
	noIdle = true;
	flagTeleporting = false;
}
...
/*
================
rvMonsterPokemonBossMakron::Event_DisablePatternMode
================
*/
void rvMonsterPokemonBossMakron::Event_DisablePatternMode(void) {
	patternedMode = false;
	noIdle = false;
}
...
/*
================
rvMonsterPokemonBossMakron::Event_Separate
================
*/
void rvMonsterPokemonBossMakron::Event_Separate(void) {
...
================
*/
void rvMonsterPokemonBossMakron::Event_FlyingRotate(idVec3& vecOrg) {
...
/*
================
rvMonsterPokemonBossMakron::Event_SetNextAction
================
*/
void rvMonsterPokemonBossMakron::Event_SetNextAction(const char* actionString) {
...
CLASS_STATES_DECLARATION(rvMonsterPokemonBossMakron)
STATE("Torso_DMGAttack", rvMonsterPokemonBossMakron::State_Torso_DMGAttack)
STATE("Torso_MeleeAttack", rvMonsterPokemonBossMakron::State_Torso_MeleeAttack)
STATE("Torso_CannonAttack", rvMonsterPokemonBossMakron::State_Torso_CannonAttack)
STATE("Torso_GrenadeAttack", rvMonsterPokemonBossMakron::State_Torso_GrenadeAttack)
STATE("Torso_CannonSweepAttack", rvMonsterPokemonBossMakron::State_Torso_CannonSweepAttack)
STATE("Torso_Lightning1Attack", rvMonsterPokemonBossMakron::State_Torso_Lightning1Attack)
STATE("Torso_Lightning2Attack", rvMonsterPokemonBossMakron::State_Torso_Lightning2Attack)
STATE("Torso_StompAttack", rvMonsterPokemonBossMakron::State_Torso_StompAttack)
STATE("Torso_Recharge", rvMonsterPokemonBossMakron::State_Torso_Recharge)
STATE("Torso_Charge", rvMonsterPokemonBossMakron::State_Torso_Charge)
STATE("Torso_KillPlayer", rvMonsterPokemonBossMakron::State_Torso_KillPlayer)
STATE("Torso_FirstDeath", rvMonsterPokemonBossMakron::State_Torso_FirstDeath)
STATE("Torso_Resurrection", rvMonsterPokemonBossMakron::State_Torso_Resurrection)
STATE("State_Killed", rvMonsterPokemonBossMakron::State_Killed)
STATE("Torso_Teleport", rvMonsterPokemonBossMakron::State_Torso_Teleport)

STATE("Torso_TurnRight90", rvMonsterPokemonBossMakron::State_Torso_TurnRight90)
STATE("Torso_TurnLeft90", rvMonsterPokemonBossMakron::State_Torso_TurnLeft90)

STATE("Torso_RotateToAngle", rvMonsterPokemonBossMakron::State_Torso_RotateToAngle)

STATE("Frame_BeginLightningSweep2", rvMonsterPokemonBossMakron::Frame_BeginLightningSweep2)
STATE("Frame_EndLightningSweep2", rvMonsterPokemonBossMakron::Frame_EndLightningSweep2)
STATE("Frame_StompAttack", rvMonsterPokemonBossMakron::Frame_StompAttack)
STATE("Frame_Teleport", rvMonsterPokemonBossMakron::Frame_Teleport)

STATE("State_ScriptedFace", rvMonsterPokemonBossMakron::State_ScriptedFace)
...
================
*/
stateResult_t rvMonsterPokemonBossMakron::State_Torso_DMGAttack(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT
	};
...
================
*/
stateResult_t rvMonsterPokemonBossMakron::State_Torso_Charge(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT
	};
...
stateResult_t rvMonsterPokemonBossMakron::State_ScriptedFace(const stateParms_t& parms) {
...
================
*/
stateResult_t rvMonsterPokemonBossMakron::State_Torso_FirstDeath(const stateParms_t& parms) {
...
================
*/
stateResult_t rvMonsterPokemonBossMakron::State_Torso_Resurrection(const stateParms_t& parms) {
	/*	enum {
			STAGE_INIT,
			STAGE_WAIT_FIRST,
			STAGE_RISE,
...
================
*/
stateResult_t rvMonsterPokemonBossMakron::State_Torso_Lightning2Attack(const stateParms_t& parms) {
...
/*
================
rvMonsterPokemonBossMakron::State_Torso_StompAttack
================
*/
stateResult_t rvMonsterPokemonBossMakron::State_Torso_StompAttack(const stateParms_t& parms) {
...
/*
================
rvMonsterPokemonBossMakron::State_Torso_Teleport
================
*/
stateResult_t rvMonsterPokemonBossMakron::State_Torso_Teleport(const stateParms_t& parms) {
...
================
*/
stateResult_t rvMonsterPokemonBossMakron::State_Torso_GrenadeAttack(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT
	};
...
================
*/
stateResult_t rvMonsterPokemonBossMakron::State_Torso_Recharge(const stateParms_t& parms) {
...
================
*/
stateResult_t rvMonsterPokemonBossMakron::State_Torso_MeleeAttack(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT
	};
...
/*
================
rvMonsterPokemonBossMakron::State_Torso_RotateToAngle
================
*/
stateResult_t rvMonsterPokemonBossMakron::State_Torso_RotateToAngle(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT_LOOP,
	};
...
/*
================
rvMonsterPokemonBossMakron::State_Torso_TurnRight90
================
*/
stateResult_t rvMonsterPokemonBossMakron::State_Torso_TurnRight90(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT
	};
...
/*
================
rvMonsterPokemonBossMakron::State_Torso_TurnLeft90
================
*/
stateResult_t rvMonsterPokemonBossMakron::State_Torso_TurnLeft90(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT
	};
...
/*
================
rvMonsterPokemonBossMakron::State_Torso_CannonAttack
================
*/
stateResult_t rvMonsterPokemonBossMakron::State_Torso_CannonAttack(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAITSTART,
		STAGE_LOOP,
...
/*
================
rvMonsterPokemonBossMakron::State_Torso_Lightning1Attack
================
*/

stateResult_t rvMonsterPokemonBossMakron::State_Torso_Lightning1Attack(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAITSTART,
		STAGE_INIT_BOLT,
...
/*
================
rvMonsterPokemonBossMakron::State_Torso_KillPlayer
================
*/

stateResult_t rvMonsterPokemonBossMakron::State_Torso_KillPlayer(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAITSTART,
		STAGE_LOOP,
...
================
*/
stateResult_t rvMonsterPokemonBossMakron::State_Torso_CannonSweepAttack(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT
	};
...
/*
================
rvMonsterPokemonBossMakron::State_Killed
================
*/
stateResult_t rvMonsterPokemonBossMakron::State_Killed(const stateParms_t& parms) {
	enum {
		STAGE_FALLSTART,
		STAGE_FALLSTARTWAIT,
		STAGE_FALLLOOPWAIT,
...
/*
================
rvMonsterPokemonBossMakron::Frame_BeginLightningSweep2
================
*/

stateResult_t rvMonsterPokemonBossMakron::Frame_BeginLightningSweep2(const stateParms_t& parms) {
...
stateResult_t rvMonsterPokemonBossMakron::Frame_EndLightningSweep2(const stateParms_t& parms) {
...
/*
================
rvMonsterPokemonBossMakron::Frame_Teleport
================
*/

stateResult_t rvMonsterPokemonBossMakron::Frame_Teleport(const stateParms_t& parms) {
...
/*
================
rvMonsterPokemonBossMakron::Frame_StompAttack
================
*/

stateResult_t rvMonsterPokemonBossMakron::Frame_StompAttack(const stateParms_t& parms) {
...
/*
================
rvMonsterPokemonBossMakron::Event_ToggleCornerState
================
*/
void rvMonsterPokemonBossMakron::Event_ToggleCornerState(float f) {
	if (f == 1.0f) {
...
/*
================
rvMonsterPokemonBossMakron::Event_StompAttack
================
*/

void rvMonsterPokemonBossMakron::Event_StompAttack(idVec3& origin) {
